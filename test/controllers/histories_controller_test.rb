...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { borrow_id: @history.borrow_id, staff_id: @history.staff_id } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { borrow_id: @history.borrow_id, staff_id: @history.staff_id } }
